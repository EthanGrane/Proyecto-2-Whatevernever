...
onMounted(() => {
  ...
  if (popupElement) {
    ...
    popupElement.style.left = "128px";
    popupElement.style.top = "128px";
  }
});
...
<template>
  <div v-if="popupIndex != -1" ref="popup" class="popup" id="create-marker-popup" @mousedown="startDrag">
    ...
    <!-- Select Marker List -->
    <div v-if="popupIndex == 1" id="popup-newMarker-list" class="w-100 d-flex flex-column flex-grow-1" style="overflow-y: scroll; max-height: 50vh;">
    ...
    <div  v-if="popupIndex == 2" id="popup-newMarker-summary" class="w-100 d-flex flex-column flex-grow-1">
      ...
      <p style="margin-left: 16px !important;">Esto es una descripcion de ejemplo sobre este marcador maravilloso el cual he marcado para poder tener marcada la ubicacion de este maravilloso parque.</p>
    </div>
